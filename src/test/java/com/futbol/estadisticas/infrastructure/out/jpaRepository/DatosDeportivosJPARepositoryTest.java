...
class DatosDeportivosJPARepositoryTest extends PostgresTestContainerConfig {
    ...
    private static Deque<PosicionJugador> deque(PosicionJugador... posiciones) {
        Deque<PosicionJugador> d = new ArrayDeque<>();
        for (PosicionJugador p : posiciones) {
            d.add(p);
        }
        return d;
    }
    ...
    @BeforeEach
    void setUp() {
        // Orden por FKs: datos_deportivos -> jugadores
        ...
        DatosDeportivosJPAEntity datos3 = DatosDeportivosJPAEntity.builder()
                ...
                .jugador(jugador3)
                .posiciones(new ArrayList<>(List.of(PosicionJugador.MEDIOCAMPISTA_OFENSIVO)))
                .dorsal(20)
                .estadoJugador(EstadoJugador.LESIONADO)
                .valorMercado(70_000_000.0)
                .fechaActualizacion(HOY)
                .build();
    ...
    void testFindById() {
        ...
        assertThat(datos.get().getPosiciones()).hasSize(1);
        assertThat(datos.get().getDorsal()).isEqualTo(7);
        assertThat(datos.get().getValorMercado()).isEqualTo(85_000_000.0);
    ...
    void testFindByEstado() {
        ...
        assertThat(titulares)
                ...
                .containsExactlyInAnyOrder(85_000_000.0, 200_000_000.0);
        assertThat(titulares)
        ...
        assertThat(lesionados.get(0).getValorMercado()).isEqualTo(70_000_000.0);
    ...
    @Test
    @DisplayName("deleteById: debe eliminar datos deportivos por ID del historial")
    void testDeleteById() {
        assertThat(adapter.existsByJugador(ID_JUGADOR_3)).isTrue();

        adapter.deleteById(ID_DATOS_3);

        assertThat(adapter.existsByJugador(ID_JUGADOR_3)).isFalse();
        assertThat(adapter.existsByJugador(ID_JUGADOR_1)).isTrue();
        assertThat(adapter.existsByJugador(ID_JUGADOR_2)).isTrue();
    }
    ...
    void testSave() {
        ...
        DatosDeportivos nuevosDatos = DatosDeportivos.builder()
                ...
                .posiciones(deque(PosicionJugador.DEFENSA_CENTRAL))
                .dorsal(10)
                .estadoJugador(EstadoJugador.SUPLENTE)
                .valorMercado(50_000_000.0)
                .build();
        ...
        assertThat(guardado.getPosicionActual()).isEqualTo(PosicionJugador.DEFENSA_CENTRAL);
        assertThat(guardado.getPosiciones()).hasSize(1);
        assertThat(guardado.getDorsal()).isEqualTo(10);
        assertThat(guardado.getValorMercado()).isEqualTo(50_000_000.0);
        ...
        assertThat(encontrado.get().getValorMercado()).isEqualTo(50_000_000.0);
    ...
    void testUpdate() {
        ...
        assertThat(datos.getValorMercado()).isEqualTo(85_000_000.0);
        ...
        assertThat(guardado.getPosicionActual()).isEqualTo(PosicionJugador.DELANTERO_DERECHO);
        assertThat(guardado.getDorsal()).isEqualTo(11);
        assertThat(guardado.getValorMercado()).isEqualTo(90_000_000.0);

        Optional<DatosDeportivos> encontrado = adapter.findById(ID_DATOS_1);
        assertThat(encontrado).isPresent();
        assertThat(encontrado.get().getDorsal()).isEqualTo(11);
        assertThat(encontrado.get().getValorMercado()).isEqualTo(90_000_000.0);
